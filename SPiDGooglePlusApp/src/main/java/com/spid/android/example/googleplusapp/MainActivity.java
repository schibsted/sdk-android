...
public class MainActivity extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void signupWithGooglePlusToken(final String token) {
        SPiDUser.signupWithGooglePlus(getPackageName(), token, new SPiDAuthorizationListener() {
            ...
            @Override
            public void onSPiDException(SPiDException exception) {
                onError("SPiDException when creating user from Google Plus token: " + exception.getMessage());
            }

            @Override
            public void onIOException(IOException exception) {
                onError("IOException when creating user from Google Plus token: " + exception.getMessage());
            }

            @Override
            public void onException(Exception exception) {
                onError("Exception when creating user from Google Plus token: " + exception.getMessage());
            }
